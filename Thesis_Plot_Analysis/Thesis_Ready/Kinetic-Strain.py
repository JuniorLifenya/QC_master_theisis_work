...
# Layout changed to 'constrained' to prevent clipping automatically
...
for row, pol in enumerate(['plus', 'cross']):
    ...
    ax_ref.set_xlim(-2.5, 2.5)
    ax_ref.set_ylim(-2.5, 2.5)
    
    ax_ref.set_title("Standard Isotropic", fontweight='bold')
    ax_ref.set_xlabel(r'$p_x/p_0$')
    ax_ref.set_ylabel(r'$p_y/p_0$')
